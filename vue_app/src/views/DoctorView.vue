    ...
    <div class="home">
      ...
      <div class="columns is-mobile grid-xl">
        <div class="column is-flex is-flex-direction-column is-align-items-center">
          ...
          <img :src="`${object.image}`" class="image mt-4" style="max-width: 25%; height: auto;">
          <div v-if="object.inference === 'NO PNEUMONIA DETECTED'" class="text-centered mt-6 is-size-6 has-text-weight-bold notification is-success">{{ object.inference }}</div>
